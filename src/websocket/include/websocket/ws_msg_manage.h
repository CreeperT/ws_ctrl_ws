...
class WSmsgs_Manager_Client : public rclcpp::Node
{
public:
    WSmsgs_Manager_Client(const char* node_name);
...
class WSmsgs_Manager_Server : public rclcpp::Node
{
public:
    WSmsgs_Manager_Server(const char* node_name);
